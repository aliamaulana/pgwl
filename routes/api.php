...
//GeoJSON point
Route::get('/points', [PointController::class, 'index'])->name('api.points'); // mengambil url points di pointcontroller
...
// //GeoJSON polygon
// Route::get('/kecamatans', [KecamatanController::class, 'index'])->name('api.kecamatans');
// Route::get('/kecamatan/{gid}', [KecamatanController::class, 'show'])->name('api.kecamatan');
