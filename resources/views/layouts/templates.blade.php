                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            {{-- <li><a class="dropdown-item" href="{{ route('table-polyline') }}">Tabel Polylines</a></li>
                            <li><a class="dropdown-item" href="{{ route('table-polygon') }}">Tabel Polygons</a></li> --}}
                        </ul>
                    </li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p> Nama : Alia Maulana Resti</p>
                    <p> NIM : 22/492734/SV/20607</p>
                    <p> Kelas : PGWL A</p>
                </div>
